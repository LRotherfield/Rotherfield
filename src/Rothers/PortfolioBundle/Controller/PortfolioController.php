...
use Rothers\PortfolioBundle\Entity\Portfolio;
use Rothers\PortfolioBundle\Form\PortfolioType;
...
class PortfolioController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PortfolioBundle:Portfolio')->find($id);
     ...
     * @Method("post")
     * @Template("Rothers\PortfolioBundle:Portfolio:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("Rothers\PortfolioBundle:Portfolio:edit.html.twig")
     */
